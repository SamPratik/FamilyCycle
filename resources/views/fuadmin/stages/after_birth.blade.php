...
<body>
  ...
  <div class="container text-center" style="position:relative;top:100px;">
    <div class="row">
      ...
      <a class="col-md-4 af-links" href="{{ route('fuadmin.ab.babyNutrition') }}">
      ...
      <a class="col-md-4 af-links" href="{{ route('fuadmin.ab.motherNutrition') }}">
      {{-- <div class="col-md-4" style="box-shadow:0px 0px 10px black;border-radius:10px;"> --}}
        <div>
      ...
      <a class="col-md-4 af-links" href="{{ route('fuadmin.ab.vaccination') }}">
      {{-- <div class="col-md-4" style="box-shadow:0px 0px 10px black;border-radius:10px;"> --}}
        <div>
    ...
    <div class="row">
      <a class="col-md-4 af-links" href="{{ route('fuadmin.ab.diseases') }}">
      {{-- <div class="col-md-4" style="box-shadow:0px 0px 10px black;border-radius:10px;"> --}}
        <div>
      ...
      <a class="col-md-4 af-links" href="{{ route('fuadmin.ab.photoAlbum') }}">
      {{-- <div class="col-md-4" style="box-shadow:0px 0px 10px black;border-radius:10px;"> --}}
        <div>
      ...
      <a class="col-md-4 af-links" href="{{ route('fuadmin.ab.guidelines') }}">
      {{-- <div class="col-md-4" style="box-shadow:0px 0px 10px black;border-radius:10px;"> --}}
        <div>
    ...
    <div class="row">
      <a class="col-md-4 af-links" href="{{ route('fuadmin.ab.calculators') }}">
      {{-- <div class="col-md-4" style="box-shadow:0px 0px 10px black;border-radius:10px;"> --}}
        <div>
